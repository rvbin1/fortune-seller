 ...
 */
final class Version20250227115428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, gw2_id INT NOT NULL, pic_url VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, sellable TINYINT(1) NOT NULL, attributes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
