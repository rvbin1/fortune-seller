 ...
 */
final class Version20250227114206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, gw2_id INT NOT NULL, pic_url VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, sellable TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
